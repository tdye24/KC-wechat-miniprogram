...
// GET 用来处理发来的题库请求
router.get('/questions/zhengzhi', controllers.questions.zhengzhi)
router.get('/questions/hongguan', controllers.questions.hongguan)
router.get('/questions/weiguan', controllers.questions.weiguan)
